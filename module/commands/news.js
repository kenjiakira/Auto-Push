...
module.exports.config = {
  ...
  description: "Xem tin tức mới nhất từ VnExpress và tạo mô tả từ AI",
...
async function generateNewsDescription(newsData) {
  let description = '';
...
module.exports.run = async function({ api, event }) {
  try {
    ...
    const newsDescription = await generateNewsDescription(newsData);
